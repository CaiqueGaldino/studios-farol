...
export default function Footer() {
  return (
    <footer className="w-full bg-gradient-to-b from-gray-900 to-black text-white py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Transformamos ideias em produções audiovisuais que emocionam e contam histórias únicas.
            </p>
            {/* Redes Sociais */}
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              <li className="flex items-start gap-2">
                ...
                <span>contato@studiosfarol.com</span>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-5 h-5 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} Studios Farol. Todos os direitos reservados.
            </p>
